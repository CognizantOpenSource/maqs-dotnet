...
* [Override the GetDataBaseConnection method](MAQS_9/Database/DatabaseBaseTest.md)
* [Create your own DatabaseDriver](MAQS_9/Database/DatabaseDriver.md)
* [Implement the IProvider Class](MAQS_9/Database/DatabaseProviders.md)
